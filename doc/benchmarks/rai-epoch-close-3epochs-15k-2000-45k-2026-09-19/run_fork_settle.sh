...
: > "$SNAP"
DATA=$HOME/NanoSpam
S=/Users/ruimorais/rsnano-node/doc/benchmarks/rai-epoch-close-3epochs-15k-2000-45k-2026-09-19
...
for attempt in 1 2 3; do
  ...
  START=$(date +%s)
  caffeinate -i nanospam --prs 6 --no-prio --blocks 45000 --accounts 45000 --rate 2000 --fork-percentage 5 --epoch-terminated-elections 15000 --no-kill > "$OUT" 2>&1 &
  NSPID=$!
