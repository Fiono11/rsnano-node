...
# One Byzantine member and one silent one: the silent representative runs
# its node and receives the epoch's votes but casts none, then signs its
# report at the boundary and votes in the close - absent from the voting,
# present for the handoff. Within the bound: five reports, one faulty member.
run fork5-silent1-byz1 5 5 --silent 1 --byzantine 1
echo "\n########## verdicts ##########"; cat $V
