...
impl NodeConfig {
    ...
    pub fn new(
        ...
        Self {
            ...
            fork_cache_max_size: DEFAULT_MAX_LEN,
            fork_cache_max_forks_per_root: DEFAULT_MAX_FORKS_PER_ROOT,
            bootstrap_stale_threshold: DEFAULT_STALE_THRESHOLD,
            vote_rebroadcaster_max_queue: DEFAULT_MAX_QUEUE,
...
mod tests {
    ...
    fn default_values() {
        ...
        assert_eq!(config.fork_cache_max_size, DEFAULT_MAX_LEN);
        assert_eq!(
