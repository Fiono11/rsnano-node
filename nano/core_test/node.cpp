...
TEST (node, fork_no_vote_quorum)
{
	...
	auto vote = std::make_shared<nano::vote> (key1, key3, 0, 0, std::vector<nano::block_hash>{ send2->hash () }, nano::vote_type::vote, 0);
...
TEST (node, DISABLED_fork_stale)
{
	...
	auto vote = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector<nano::block_hash> (), nano::vote_type::vote, 0);
...
TEST (node, rep_weight)
{
	...
	auto vote0 = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
	auto vote1 = std::make_shared<nano::vote> (keypair1.pub, keypair1.prv, 0, 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
	auto vote2 = std::make_shared<nano::vote> (keypair2.pub, keypair2.prv, 0, 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
...
TEST (node, rep_remove)
{
	...
	auto vote_rep1 = std::make_shared<nano::vote> (keys_rep1.pub, keys_rep1.prv, 0, 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
	...
	auto vote_genesis_rep = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
	...
	auto vote_rep2 = std::make_shared<nano::vote> (keys_rep2.pub, keys_rep2.prv, 0, 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
...
TEST (node, online_reps_rep_crawler)
{
	...
	auto vote = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, nano::milliseconds_since_epoch (), 0, std::vector<nano::block_hash>{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
	ASSERT_EQ (0, node1.online_reps.online ());
	// Without rep crawler
...
TEST (node, online_reps_election)
{
	...
	auto vote = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, nano::milliseconds_since_epoch (), 0, std::vector<nano::block_hash>{ send1->hash () }, nano::vote_type::vote, 0);
	ASSERT_EQ (0, node1.online_reps.online ());
	node1.vote_processor.vote_blocking (vote, std::make_shared<nano::transport::fake::channel> (node1));
...
TEST (node, local_votes_cache_fork)
{
	...
	ASSERT_EQ (nano::process_result::progress, node1.process (*send1).code);
	// Cache vote
	auto vote (std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector<nano::block_hash> (1, send1->hash ()), nano::vote_type::vote, 0));
...
TEST (node, vote_republish)
{
	...
	auto vote (std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, nano::vote::timestamp_max, nano::vote::duration_max, std::vector<nano::block_hash>{ send2->hash () }, nano::vote_type::vote, 0));
	node1.vote_processor.vote (vote, std::make_shared<nano::transport::fake::channel> (node1));
...
TEST (node, vote_by_hash_republish)
{
	...
	auto vote = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, nano::vote::timestamp_max, nano::vote::duration_max, vote_blocks, nano::vote_type::vote, 0);
	node1.vote_processor.vote (vote, std::make_shared<nano::transport::fake::channel> (node1));
...
TEST (node, DISABLED_vote_by_hash_epoch_block_republish)
{
	...
	auto vote (std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, vote_blocks, nano::vote_type::vote, 0));
...
TEST (node, DISABLED_fork_invalid_block_signature)
{
	...
	auto vote (std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector<nano::block_hash>{ send2->hash () }, nano::vote_type::vote, 0));
	auto vote_corrupt (std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector<nano::block_hash>{ send2_corrupt->hash () }, nano::vote_type::vote, 0));
...
TEST (node, rollback_vote_self)
{
...

	{
		...
		// election->vote1 (key.pub, 0, fork->hash ());
...
TEST (rep_crawler, local)
{
	...
	auto vote = std::make_shared<nano::vote> (nano::dev::genesis_key.pub, nano::dev::genesis_key.prv, 0, 0, std::vector{ nano::dev::genesis->hash () }, nano::vote_type::vote, 0);
	{
