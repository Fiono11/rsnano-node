...
std::size_t nano::unchecked_map::entries_size () const
{
	return rsnano::rsn_unchecked_map_entries_size (handle);
}
...
std::size_t nano::unchecked_map::buffer_size () const
{
	return rsnano::rsn_unchecked_map_buffer_size (handle);
}
